...
### Need to automate the uploading and encoding of videos into the system

### Need to implement some more features on the frontend, like a video library page and a way to view CDN node status/metrics
