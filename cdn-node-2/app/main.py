...
NODE_ID       = os.getenv("NODE_ID",       "cdn-node-2")
NODE_NAME     = os.getenv("NODE_NAME",     "edge-chittagong")
NODE_LOCATION = os.getenv("NODE_LOCATION", "chittagong")
NODE_PORT     = int(os.getenv("NODE_PORT", "3002"))
